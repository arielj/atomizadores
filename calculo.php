    ...
    <div id='calculo'>
      ...
      <div id='dimensiones'>
        ...
        <div id="divVelocidad" class="float">
          ...
          <br />
          <input type="number" id="velocidad" min='80' max='300' class='spinner' size="5" value="190"/>
          <br />
      ...
      <div id='atomizadores'>
        <div id="divAtomizador6" class="float atomizador">
          ...
          <input type="number" id="atomizador6" class='hole disabled' min='1' max='5' size="5" value="3" disabled='disabled' /><br />
        ...
        <div id="divAtomizador5" class="float atomizador">
          ...
          <input type="number" id="atomizador5" class="hole disabled" min='1' max='5' size="5" value="3" disabled='disabled'/><br />
          Deshabilitar <input type="checkbox" class='disable_atom' checked='checked'>
        </div>
        <div id="divAtomizador4" class="float atomizador">
          <span>Atomizador 4</span><br />
          <input type="number" id="atomizador4" class="hole" min='1' max='5' size="5" value="3"/><br />
          Deshabilitar <input type="checkbox" class='disable_atom'>
        </div>
        <div id="divAtomizador3" class="float atomizador">
          <span>Atomizador 3</span><br />
          <input type="number" id="atomizador3" class="hole" min='1' max='5' size="5" value="3"/><br />
          Deshabilitar <input type="checkbox" class='disable_atom'>
        </div>
        <div id="divAtomizador2" class="float atomizador">
          <span>Atomizador 2</span><br />
          <input type="number" id="atomizador2" class="hole" min='1' max='5' size="5" value="3"/><br />
          Deshabilitar <input type="checkbox" class='disable_atom'>
        </div>
        <div id="divAtomizador1" class="float atomizador">
          <span>Atomizador 1</span><br />
          <input type="number" id="atomizador1" class="hole" min='1' max='5' size="5" value="3"/><br />
          Deshabilitar <input type="checkbox" class='disable_atom'>
        </div>
        <div style="clear:both"></div>
      </div>
      <div id="chorro">
		  <div id="divPresion" class="float">
			...
			<input type="number" id="presion" min='20' max='60' step='10' size="5" value="30"/>
		  </div>
